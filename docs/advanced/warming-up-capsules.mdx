...
You *warm up* warm up capsules
(yes, "warm up capsules" are a particular type of capsule used in this pattern)
...
<Zapp id="github/GregoryConrad/rearch-dart/tree/main/packages/examples/count_warm_up" />
